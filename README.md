...
Tecs is a typed entity component system and 2D game engine for LuaJIT, written
in Teal and built on SDL3, SDL_GPU, and Rapier. Entities are the interface:
anything that updates or renders belongs to a world.
...
Opaque 3D rendering, post-processing, tiled maps, and multi-camera are not
yet built.
...
cargo xtask example ui-demo    # Run the showcase
