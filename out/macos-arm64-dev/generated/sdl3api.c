...
typedef struct Tecs2dSdl3Api {
    ...
    _Bool (*SDL_SetMemoryFunctions)(SDL_malloc_func malloc_func, SDL_calloc_func calloc_func, SDL_realloc_func realloc_func, SDL_free_func free_func);
    ...
    _Bool (*SDL_SetError)(const char *fmt, ...);
    _Bool (*SDL_SetErrorV)(const char *fmt, va_list ap);
    ...
    _Bool (*SDL_WaitConditionTimeout)(SDL_Condition *cond, SDL_Mutex *mutex, Sint32 timeoutMS);
    ...
    _Bool (*SDL_GPUSupportsShaderFormats)(SDL_GPUShaderFormat format_flags, const char *name);
    _Bool (*SDL_GPUSupportsProperties)(SDL_PropertiesID props);
    SDL_GPUDevice * (*SDL_CreateGPUDevice)(SDL_GPUShaderFormat format_flags, _Bool debug_mode, const char *name);
    ...
    void * (*SDL_MapGPUTransferBuffer)(SDL_GPUDevice *device, SDL_GPUTransferBuffer *transfer_buffer, _Bool cycle);
    ...
    void (*SDL_UploadToGPUTexture)(SDL_GPUCopyPass *copy_pass, const SDL_GPUTextureTransferInfo *source, const SDL_GPUTextureRegion *destination, _Bool cycle);
    void (*SDL_UploadToGPUBuffer)(SDL_GPUCopyPass *copy_pass, const SDL_GPUTransferBufferLocation *source, const SDL_GPUBufferRegion *destination, _Bool cycle);
    void (*SDL_CopyGPUTextureToTexture)(SDL_GPUCopyPass *copy_pass, const SDL_GPUTextureLocation *source, const SDL_GPUTextureLocation *destination, Uint32 w, Uint32 h, Uint32 d, _Bool cycle);
    void (*SDL_CopyGPUBufferToBuffer)(SDL_GPUCopyPass *copy_pass, const SDL_GPUBufferLocation *source, const SDL_GPUBufferLocation *destination, Uint32 size, _Bool cycle);
    ...
    _Bool (*SDL_WindowSupportsGPUSwapchainComposition)(SDL_GPUDevice *device, SDL_Window *window, SDL_GPUSwapchainComposition swapchain_composition);
    _Bool (*SDL_WindowSupportsGPUPresentMode)(SDL_GPUDevice *device, SDL_Window *window, SDL_GPUPresentMode present_mode);
    _Bool (*SDL_ClaimWindowForGPUDevice)(SDL_GPUDevice *device, SDL_Window *window);
    void (*SDL_ReleaseWindowFromGPUDevice)(SDL_GPUDevice *device, SDL_Window *window);
    _Bool (*SDL_SetGPUSwapchainParameters)(SDL_GPUDevice *device, SDL_Window *window, SDL_GPUSwapchainComposition swapchain_composition, SDL_GPUPresentMode present_mode);
    _Bool (*SDL_SetGPUAllowedFramesInFlight)(SDL_GPUDevice *device, Uint32 allowed_frames_in_flight);
    SDL_GPUTextureFormat (*SDL_GetGPUSwapchainTextureFormat)(SDL_GPUDevice *device, SDL_Window *window);
    _Bool (*SDL_AcquireGPUSwapchainTexture)(SDL_GPUCommandBuffer *command_buffer, SDL_Window *window, SDL_GPUTexture **swapchain_texture, Uint32 *swapchain_texture_width, Uint32 *swapchain_texture_height);
    _Bool (*SDL_WaitForGPUSwapchain)(SDL_GPUDevice *device, SDL_Window *window);
    _Bool (*SDL_WaitAndAcquireGPUSwapchainTexture)(SDL_GPUCommandBuffer *command_buffer, SDL_Window *window, SDL_GPUTexture **swapchain_texture, Uint32 *swapchain_texture_width, Uint32 *swapchain_texture_height);
    _Bool (*SDL_SubmitGPUCommandBuffer)(SDL_GPUCommandBuffer *command_buffer);
    SDL_GPUFence * (*SDL_SubmitGPUCommandBufferAndAcquireFence)(SDL_GPUCommandBuffer *command_buffer);
    _Bool (*SDL_CancelGPUCommandBuffer)(SDL_GPUCommandBuffer *command_buffer);
    _Bool (*SDL_WaitForGPUIdle)(SDL_GPUDevice *device);
    _Bool (*SDL_WaitForGPUFences)(SDL_GPUDevice *device, _Bool wait_all, SDL_GPUFence *const *fences, Uint32 num_fences);
    _Bool (*SDL_QueryGPUFence)(SDL_GPUDevice *device, SDL_GPUFence *fence);
    ...
    _Bool (*SDL_GPUTextureSupportsFormat)(SDL_GPUDevice *device, SDL_GPUTextureFormat format, SDL_GPUTextureType type, SDL_GPUTextureUsageFlags usage);
    _Bool (*SDL_GPUTextureSupportsSampleCount)(SDL_GPUDevice *device, SDL_GPUTextureFormat format, SDL_GPUSampleCount sample_count);
    ...
    _Bool (*SDL_UpdateYUVTexture)(SDL_Texture *texture, const SDL_Rect *rect, const Uint8 *Yplane, int Ypitch, const Uint8 *Uplane, int Upitch, const Uint8 *Vplane, int Vpitch);
    _Bool (*SDL_UpdateNVTexture)(SDL_Texture *texture, const SDL_Rect *rect, const Uint8 *Yplane, int Ypitch, const Uint8 *UVplane, int UVpitch);
    _Bool (*SDL_LockTexture)(SDL_Texture *texture, const SDL_Rect *rect, void **pixels, int *pitch);
    ...
    _Bool (*SDL_RenderTextureRotated)(SDL_Renderer *renderer, SDL_Texture *texture, const SDL_FRect *srcrect, const SDL_FRect *dstrect, double angle, const SDL_FPoint *center, SDL_FlipMode flip);
    _Bool (*SDL_RenderTextureAffine)(SDL_Renderer *renderer, SDL_Texture *texture, const SDL_FRect *srcrect, const SDL_FPoint *origin, const SDL_FPoint *right, const SDL_FPoint *down);
    ...
    _Bool (*SDL_RenderGeometry)(SDL_Renderer *renderer, SDL_Texture *texture, const SDL_Vertex *vertices, int num_vertices, const int *indices, int num_indices);
    _Bool (*SDL_RenderGeometryRaw)(SDL_Renderer *renderer, SDL_Texture *texture, const float *xy, int xy_stride, const SDL_FColor *color, int color_stride, const float *uv, int uv_stride, int num_vertices, const void *indices, int num_indices, int size_indices);
    ...
    _Bool (*SDL_RenderDebugTextFormat)(SDL_Renderer *renderer, float x, float y, const char *fmt, ...);
...
static const Tecs2dSdl3Api api = {
...
const void *tecs2d_sdl3_api(void)
{
    return &api;
}
