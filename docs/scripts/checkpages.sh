#!/usr/bin/env bash
#
# Holds the documentation to the surface: every public name has a page, and
# every page under docs/modules/ names something public.
#
...
count=$(printf '%s\n' $public | wc -l | tr -d ' ')
echo "OK: all $count public names have a page, and no page outlives its module"
