---
url: /modules/filesystem.md
description: >-
  Where a game may read and write, what to do with a path once you have one, and
  the watcher that reports when a file changed
---
...
| ------------------------- | --------------------------- | ----------------------------------------------------------------------------------------------------------------------- |
| string | relative | A path under the content root, with `/` separators. Joined, not validated: nothing here asks whether the file is there. |
...
| Type                      | Description                                                                                                                |
| ------------------------- | -------------------------------------------------------------------------------------------------------------------------- |
| string | `TECS_ASSETS` if it is set, then what the host was told at build time, then `basePath`. Cached until the platform changes. |
...
| Type                      | Description                                                                                                                                                            |
| ------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| string | The directory. Empty rather than nil when the platform declines to say, which is the case on some targets and is not an error: a caller falls back to a relative path. |
...
| Type                      | Description                           |
| ------------------------- | ------------------------------------- |
| string | The directory, or nil and the reason. |
| string |                                       |
...
| ------------------------------------------------------------------------- | -------------------------- | ---------------------------------------------------------- |
| string                                                 | path    |                                                            |
| string                                                 | pattern | `*` and `?` wildcards, or nil for everything, recursively. |
| GlobOptions | options |                                                            |
...
| Type                        | Description                                                                                                                    |
| --------------------------- | ------------------------------------------------------------------------------------------------------------------------------ |
| {string} | The entries, or nil and the reason `path` could not be enumerated. An empty list means an empty directory, which nil does not. |
| string   |                                                                                                                                |
...
| Type                                                        | Description                      |
| ----------------------------------------------------------- | -------------------------------- |
| Info | The info, or nil and the reason. |
| string                                   |                                  |
...
| Type                        | Description                       |
| --------------------------- | --------------------------------- |
| {string} | The names, or nil and the reason. |
| string   |                                   |
...
| Type                                 | Description                                                                                                                                        |
| ------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------------------- |
| {string : string} | The live table, so something consulting it periodically does not copy it. Shared, so a caller that means to keep it does not also mean to edit it. |
...
| Type                                                            | Description                                      |
| --------------------------------------------------------------- | ------------------------------------------------ |
| Reader | The reader, or nil and the reason there is none. |
| string                                       |                                                  |
...
| Type                                                            | Description                                      |
| --------------------------------------------------------------- | ------------------------------------------------ |
| Writer | The writer, or nil and the reason there is none. |
| string                                       |                                                  |
...
| Type                      | Description                                                                                                                                                                                                                              |
| ------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| string | The directory, with a trailing separator, named from `organisation` and `application`. The only place a build may write: everything else is read-only on at least one target, and finding that out at run time on a device is expensive. |
...
| Type                      | Name                    | Description                                                                                                                                                                                                                                              |
| ------------------------- | ----------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| string | path | An absolute path, or one `assetPath` has resolved.                                                                                                                                                                                                       |
| string | kind | What the bytes were read as, for anything watching what this process has opened. Bytes are bytes, so nothing here can tell a font's metrics from a level; whatever asked can, and this is where it says so. Omitted, the path is recorded as a document. |

#### Returns

| Type                      | Description                                        |
| ------------------------- | -------------------------------------------------- |
| string | The bytes, or nil when the file could not be read. |
...
| Type                      | Name                    | Description                                                                                                              |
| ------------------------- | ----------------------- | ------------------------------------------------------------------------------------------------------------------------ |
| string | root | The directory to read content from. A trailing separator is added when it is missing rather than doubled when it is not. |
...
| Type                      | Description                        |
| ------------------------- | ---------------------------------- |
| string | The folder, or nil and the reason. |
| string |                                    |
...
| Type                      | Name                        | Description                            |
| ------------------------- | --------------------------- | -------------------------------------- |
| string | relative | A path under the preference directory. |
