---
url: /modules/workers.md
description: >-
  Worker threads and serialized channels: spawning a state of its own, what can
  cross between them, and how a worker is asked to stop
---
...
| Type                                                         | Description                                                                                     |
| ------------------------------------------------------------ | ----------------------------------------------------------------------------------------------- |
| Worker | A worker that must be stopped: nothing joins the thread or releases its channels on collection. |
