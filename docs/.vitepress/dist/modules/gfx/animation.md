---
url: /modules/gfx/animation.md
description: >-
  Sprite sheets and the playback that reads them: frames, tags, slices and
  pivots, the Animation component, and where a frame is resolved
---
...
### tecs.gfx.animation.DEFAULT\_DURATION
...
| ------------------------- | ------------------------------ | ----------------------------------------------------- |
| string | name        | Name to register the finished sheet under.            |
| number | imageWidth  | Size of the image the frames are cut from, in pixels. |
| number | imageHeight | The other size, in pixels.                            |

#### Returns

| Type                             | Description                                                   |
| -------------------------------- | ------------------------------------------------------------- |
| sheet.Builder | A builder, which registers the sheet when `finish` is called. |
...
| Type                       | Name                      | Description                    |
| -------------------------- | ------------------------- | ------------------------------ |
| World   | world  | The world the entity lives in. |
| integer | entity | A live entity.                 |
...
| Type                                     | Name                       | Description                                                                  |
| ---------------------------------------- | -------------------------- | ---------------------------------------------------------------------------- |
| sheet.AsepriteOptions | options | Raises on a missing name or an export the reader cannot make a sheet out of. |

#### Returns

| Type                           | Description                             |
| ------------------------------ | --------------------------------------- |
| sheet.Sheet | The finished sheet, already registered. |
...
| Type                                 | Name                       | Description                                                                                                                                                         |
| ------------------------------------ | -------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| sheet.GridOptions | options | Raises on a missing name, a non-positive image or frame size, a grid that fits no cells, or a `count` past what the grid holds. Frames come out in row-major order. |

#### Returns

| Type                           | Description                                                                 |
| ------------------------------ | --------------------------------------------------------------------------- |
| sheet.Sheet | The finished sheet, already registered under its name and carrying an `id`. |
...
| Type                                                                         | Name                       | Description                                                |
| ---------------------------------------------------------------------------- | -------------------------- | ---------------------------------------------------------- |
| Sheet             | source  | The sheet to play. Nil raises.                             |
| string                                                    | tag     | A tag the sheet names, or nil for the whole sheet.         |
| PlayOptions | options | Defaults are the sheet's own timing, looping, and playing. |

#### Returns

| Type                                                                     | Description                                                                         |
| ------------------------------------------------------------------------ | ----------------------------------------------------------------------------------- |
| Animation | A component value, not an entity: pass it to `world:spawn` or `world:set` yourself. |
...
| ---------------------------------------------------------------------------- | -------------------------- | --------------------------------------------------------------- |
| World                                                     | world   | The world the entity lives in.                                  |
| integer                                                   | entity  | A live entity, which needs a `Sprite` for playback to reach it. |
| Sheet             | source  | The sheet to play. Nil raises.                                  |
| string                                                    | tag     | A tag the sheet names, or nil for the whole sheet.              |
| PlayOptions | options | Defaults are the sheet's own timing, looping, and playing.      |
...
| Type                     | Name                     | Description                     |
| ------------------------ | ------------------------ | ------------------------------- |
| World | world | The world to add the system to. |
...
| Type                                  | Name                       | Description                                                                                                 |
| ------------------------------------- | -------------------------- | ----------------------------------------------------------------------------------------------------------- |
| sheet.RectsOptions | options | Raises on a missing name, a non-positive image size, an empty frame list, or a frame with no positive size. |
...
| Type                           | Name                     | Description                                                                                          |
| ------------------------------ | ------------------------ | ---------------------------------------------------------------------------------------------------- |
| sheet.Sheet | built | A sheet from any constructor here, registered moments ago under a name something else already holds. |

#### Returns

| Type                           | Description                                                    |
| ------------------------------ | -------------------------------------------------------------- |
| sheet.Sheet | The live sheet, and nil, or nil and the reason it was refused. |
| string      |                                                                |
...
| Type                       | Name                  | Description                     |
| -------------------------- | --------------------- | ------------------------------- |
| integer | id | An id a constructor handed out. |

#### Returns

| Type                           | Description                               |
| ------------------------------ | ----------------------------------------- |
| sheet.Sheet | The sheet, or nil when the id names none. |
...
| Type                      | Name                    | Description                        |
| ------------------------- | ----------------------- | ---------------------------------- |
| string | name | The name a constructor registered. |

#### Returns

| Type                           | Description                                 |
| ------------------------------ | ------------------------------------------- |
| sheet.Sheet | The sheet, or nil when the name names none. |
...
| Type                       | Description                                                                                                                                                                                         |
| -------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| boolean | The setting as it stands now, which decides what the next world to install the plugin gets. Worlds already carrying the systems keep the ones they were built with, so this does not describe them. |
