---
url: /modules/filesystem/watch.md
description: >-
  Polling the files this process loaded so an edit drives a reload, with settle
  rules for half-written saves
---
...
| Type                       | Description                       |
| -------------------------- | --------------------------------- |
| integer | How many changes were dispatched. |
...
| Type                       | Description                                                                                                               |
| -------------------------- | ------------------------------------------------------------------------------------------------------------------------- |
| integer | How many changes were dispatched, which is handlers run rather than paths looked at. Zero while nothing is being watched. |
