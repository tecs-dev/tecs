---
url: /ecs/relationships.md
description: >-
  Directed entity relationships via newRelationship with exclusive, sparse,
  cascadeDelete, and traversal APIs
---
...
A *simple relationship* stores only the target entity id, with no extra data on the edge. Create
