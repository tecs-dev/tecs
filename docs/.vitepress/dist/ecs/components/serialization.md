---
url: /ecs/components/serialization.md
description: >-
  Component serialize and deserialize hooks, transient, and automatic FFI schema
...
* **Mismatch**: the loader migrates per entity. It defines a struct matching the *saved* layout and reads each
  entity's bytes into it, constructs a fresh instance of the *current* component (so every field starts at its
