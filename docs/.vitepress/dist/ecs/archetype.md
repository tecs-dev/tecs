---
url: /ecs/archetype.md
description: >-
  Archetype storage groups with row and column layout, get and getMut column
  access, set, relationship lookups, dirty tracking, and lifecycle observers
---
