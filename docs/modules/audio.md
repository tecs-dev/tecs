...
<!-- @generated by docs/scripts/reference.py from src/tecs/Audio.tl, src/tecs/platform/audio.tl. Do not edit below this line. -->
...
<pre><code v-pre><a href="#tecs.audio.Audio.Sound">tecs.audio.Audio.Sound</a>: Sound
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.audio.Audio.clearSpatial">tecs.audio.Audio.clearSpatial</a>(self: Audio, handle: integer)
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.audio.Audio.clip">tecs.audio.Audio.clip</a>(self: Audio, id: integer): Audio.Clip
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.audio.Audio.clips">tecs.audio.Audio.clips</a>(self: Audio): {Audio.Clip}
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.audio.Audio.destroy">tecs.audio.Audio.destroy</a>(self: Audio)
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.audio.Audio.groupGain">tecs.audio.Audio.groupGain</a>(self: Audio, name: string): number
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.audio.Audio.groupMuted">tecs.audio.Audio.groupMuted</a>(self: Audio, name: string): boolean
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.audio.Audio.groupPaused">tecs.audio.Audio.groupPaused</a>(self: Audio, name: string): boolean
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.audio.Audio.groups">tecs.audio.Audio.groups</a>(self: Audio): {string}
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.audio.Audio.keyCount">tecs.audio.Audio.keyCount</a>(self: Audio, key: string): integer
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.audio.Audio.keys">tecs.audio.Audio.keys</a>(self: Audio): {string}
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.audio.Audio.limit">tecs.audio.Audio.limit</a>(self: Audio, key: string): Audio.Limit
</code></pre>
...
| Type                           | Description                                                                            |
| ------------------------------ | -------------------------------------------------------------------------------------- |
| <code v-pre>Audio.Limit</code> | The record that was set, not a copy, so writing through it changes the limit in force. |

<a id="tecs.audio.Audio.load"></a>

### tecs.audio.Audio.load

<pre><code v-pre>function <a href="#tecs.audio.Audio.load">tecs.audio.Audio.load</a>(self: Audio, path: string, options: Audio.LoadOptions): Audio.Clip
</code></pre>
...
| <code v-pre>Audio.LoadOptions</code> | <code v-pre>options</code> |                                                                                                                                                                          |

#### Returns

| Type                          | Description                                                                                                                                                                                                                                                            |
| ----------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <code v-pre>Audio.Clip</code> | A clip whose `status` is `"loading"` on the first call for a path and whatever it has since become on a later one. Never nil. The instance belongs to this `Audio` and is the same table every call for that path returns, so `options` is honoured only by the first. |

<a id="tecs.audio.Audio.loading"></a>

### tecs.audio.Audio.loading

<pre><code v-pre>function <a href="#tecs.audio.Audio.loading">tecs.audio.Audio.loading</a>(self: Audio): integer
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.audio.Audio.looping">tecs.audio.Audio.looping</a>(self: Audio, handle: integer): boolean
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.audio.Audio.masterGain">tecs.audio.Audio.masterGain</a>(self: Audio): number
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.audio.Audio.maxVoices">tecs.audio.Audio.maxVoices</a>(self: Audio): integer
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.audio.Audio.muted">tecs.audio.Audio.muted</a>(self: Audio): boolean
</code></pre>
...
| Type                     | Description                                                                                                                      |
| ------------------------ | -------------------------------------------------------------------------------------------------------------------------------- |
| <code v-pre>Audio</code> | nil before `install` and again after the instance is destroyed, since a destroyed one stops answering for every world it was in. |

<a id="tecs.audio.Audio.pause"></a>

### tecs.audio.Audio.pause

<pre><code v-pre>function <a href="#tecs.audio.Audio.pause">tecs.audio.Audio.pause</a>(self: Audio, handle: integer)
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.audio.Audio.pauseGroup">tecs.audio.Audio.pauseGroup</a>(self: Audio, name: string)
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.audio.Audio.paused">tecs.audio.Audio.paused</a>(self: Audio, handle: integer): boolean
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.audio.Audio.play">tecs.audio.Audio.play</a>(self: Audio, clip: Audio.Clip, options: Audio.PlayOptions): integer
</code></pre>
...
| ------------------------------------ | -------------------------- | ----------------------------------------------------------------------------------------------- |
| <code v-pre>Audio</code>             | <code v-pre>self</code>    |                                                                                                 |
| <code v-pre>Audio.Clip</code>        | <code v-pre>clip</code>    | nil is accepted and returns zero, so a `load` result may be passed straight in without a guard. |
| <code v-pre>Audio.PlayOptions</code> | <code v-pre>options</code> | Read once, here. Nothing in it is followed afterwards.                                          |
...
<pre><code v-pre>function <a href="#tecs.audio.Audio.playing">tecs.audio.Audio.playing</a>(self: Audio, handle: integer): boolean
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.audio.Audio.reload">tecs.audio.Audio.reload</a>(self: Audio, path: string): boolean, string
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.audio.Audio.resume">tecs.audio.Audio.resume</a>(self: Audio, handle: integer)
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.audio.Audio.resumeGroup">tecs.audio.Audio.resumeGroup</a>(self: Audio, name: string)
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.audio.Audio.seek">tecs.audio.Audio.seek</a>(self: Audio, handle: integer, seconds: number): boolean
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.audio.Audio.setGain">tecs.audio.Audio.setGain</a>(self: Audio, handle: integer, gain: number)
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.audio.Audio.setGroupGain">tecs.audio.Audio.setGroupGain</a>(self: Audio, name: string, gain: number)
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.audio.Audio.setGroupMuted">tecs.audio.Audio.setGroupMuted</a>(self: Audio, name: string, muted: boolean)
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.audio.Audio.setLimit">tecs.audio.Audio.setLimit</a>(self: Audio, key: string, limit: Audio.Limit)
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.audio.Audio.setMasterGain">tecs.audio.Audio.setMasterGain</a>(self: Audio, gain: number)
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.audio.Audio.setMuted">tecs.audio.Audio.setMuted</a>(self: Audio, muted: boolean)
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.audio.Audio.setPitch">tecs.audio.Audio.setPitch</a>(self: Audio, handle: integer, ratio: number)
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.audio.Audio.setPosition">tecs.audio.Audio.setPosition</a>(self: Audio, handle: integer, x: number, y: number, z: number)
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.audio.Audio.setStereo">tecs.audio.Audio.setStereo</a>(self: Audio, handle: integer, left: number, right: number)
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.audio.Audio.sounding">tecs.audio.Audio.sounding</a>(self: Audio): integer
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.audio.Audio.stop">tecs.audio.Audio.stop</a>(self: Audio, handle: integer, fadeOut: number)
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.audio.Audio.stopAll">tecs.audio.Audio.stopAll</a>(self: Audio, fadeOut: number)
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.audio.Audio.stopGroup">tecs.audio.Audio.stopGroup</a>(self: Audio, name: string, fadeOut: number)
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.audio.Audio.tell">tecs.audio.Audio.tell</a>(self: Audio, handle: integer): number
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.audio.Audio.update">tecs.audio.Audio.update</a>(self: Audio, dt: number): integer
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.audio.Audio.voices">tecs.audio.Audio.voices</a>(self: Audio): {Audio.VoiceInfo}
</code></pre>
...
| Type                                 | Description                                                                                                                                                                 |
| ------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <code v-pre>{Audio.VoiceInfo}</code> | A fresh list of fresh records each call, ordered by voice slot, which is not the order the voices started in. It is a snapshot: nothing in it follows the voice afterwards. |

<a id="tecs.audio.Audio.waitForLoads"></a>

### tecs.audio.Audio.waitForLoads

<pre><code v-pre>function <a href="#tecs.audio.Audio.waitForLoads">tecs.audio.Audio.waitForLoads</a>(self: Audio, timeoutMs: number)
</code></pre>
