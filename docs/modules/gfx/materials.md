...
A release compiles nothing. `cargo xtask shaders` walks the shader registry and writes a pack, and the
...
<!-- @generated by `cargo xtask docs-reference` from src/tecs/gpu/materials.tl. Do not edit below this line. -->
