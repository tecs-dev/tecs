...
<!-- @generated by `cargo xtask docs-reference` from src/tecs/assets.tl. Do not edit below this line. -->
...
<a id="tecs.assets.newBatch"></a>

### tecs.assets.newBatch

<pre><code v-pre>function <a href="#tecs.assets.newBatch">tecs.assets.newBatch</a>&lt;T&gt;(finished: function(T, <a href="#tecs.assets.Handle">Handle</a>)): <a href="#tecs.assets.Batch">Batch</a>&lt;T&gt;
</code></pre>
