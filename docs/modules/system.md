...
native state.
<!-- @generated by docs/scripts/reference.py from src/tecs/platform/capabilities.tl, src/tecs/platform/clipboard.tl, src/tecs/platform/proc.tl, src/tecs/platform/system.tl. Do not edit below this line. -->

## Reference

Every function and type this module carries, rendered from `src/tecs/platform/capabilities.tl`, `src/tecs/platform/clipboard.tl`, `src/tecs/platform/proc.tl` and `src/tecs/platform/system.tl`.
...
<a id="tecs.system.Options"></a>

### tecs.system.Options

<pre><code v-pre>record <a href="#tecs.system.Options">tecs.system.Options</a>
</code></pre>

What to run, and what the child inherits.
<a id="tecs.system.Options.args"></a>

### tecs.system.Options.args

<pre><code v-pre><a href="#tecs.system.Options.args">tecs.system.Options.args</a>: {string}
</code></pre>

The program and its arguments; `args[1]` is the program. A name
without a separator is resolved against `PATH`.
<a id="tecs.system.Options.cwd"></a>

### tecs.system.Options.cwd

<pre><code v-pre><a href="#tecs.system.Options.cwd">tecs.system.Options.cwd</a>: string
</code></pre>

Working directory for the child. Omitted inherits this process's.
<a id="tecs.system.Options.env"></a>

### tecs.system.Options.env

<pre><code v-pre><a href="#tecs.system.Options.env">tecs.system.Options.env</a>: {string : string}
</code></pre>
...
<a id="tecs.system.Options.clearEnv"></a>

### tecs.system.Options.clearEnv

<pre><code v-pre><a href="#tecs.system.Options.clearEnv">tecs.system.Options.clearEnv</a>: boolean
</code></pre>

Start the child's environment empty rather than inherited, so
`env` is the whole of what it sees. Optional.
<a id="tecs.system.Options.mergeStderr"></a>

### tecs.system.Options.mergeStderr

<pre><code v-pre><a href="#tecs.system.Options.mergeStderr">tecs.system.Options.mergeStderr</a>: boolean
</code></pre>
...
<a id="tecs.system.Options.input"></a>

### tecs.system.Options.input

<pre><code v-pre><a href="#tecs.system.Options.input">tecs.system.Options.input</a>: string
</code></pre>
...
<a id="tecs.system.Options.timeoutMs"></a>

### tecs.system.Options.timeoutMs

<pre><code v-pre><a href="#tecs.system.Options.timeoutMs">tecs.system.Options.timeoutMs</a>: integer
</code></pre>

Kill the child forcibly after this many milliseconds. Omitted lets
it run as long as it likes. Optional.
<a id="tecs.system.Result"></a>

### tecs.system.Result

<pre><code v-pre>record <a href="#tecs.system.Result">tecs.system.Result</a>
</code></pre>
...
and `proc.processResult` answers that from the runner's own bookkeeping.
<a id="tecs.system.Result.args"></a>

### tecs.system.Result.args

<pre><code v-pre><a href="#tecs.system.Result.args">tecs.system.Result.args</a>: {string}
</code></pre>

The program and its arguments, as given.
<a id="tecs.system.Result.pid"></a>

### tecs.system.Result.pid

<pre><code v-pre><a href="#tecs.system.Result.pid">tecs.system.Result.pid</a>: integer
</code></pre>

The child's process id.
<a id="tecs.system.Result.exitCode"></a>

### tecs.system.Result.exitCode

<pre><code v-pre><a href="#tecs.system.Result.exitCode">tecs.system.Result.exitCode</a>: integer
</code></pre>

The child's exit code, or the negated signal that ended it.
<a id="tecs.system.Result.output"></a>

### tecs.system.Result.output

<pre><code v-pre><a href="#tecs.system.Result.output">tecs.system.Result.output</a>: string
</code></pre>

Everything the child wrote to standard output.
<a id="tecs.system.Result.errorOutput"></a>

### tecs.system.Result.errorOutput

<pre><code v-pre><a href="#tecs.system.Result.errorOutput">tecs.system.Result.errorOutput</a>: string
</code></pre>

Everything it wrote to standard error, or "" when `mergeStderr`
folded that into `output`.
<a id="tecs.system.Result.succeeded"></a>

### tecs.system.Result.succeeded

<pre><code v-pre>function <a href="#tecs.system.Result.succeeded">tecs.system.Result.succeeded</a>(self: <a href="#tecs.system.Result">Result</a>): boolean
</code></pre>
...
| Type                                                        | Name                    | Description |
| ----------------------------------------------------------- | ----------------------- | ----------- |
| <code v-pre><a href="#tecs.system.Result">Result</a></code> | <code v-pre>self</code> |             |
...
<pre><code v-pre>function <a href="#tecs.system.killProcess">tecs.system.killProcess</a>(run: Future&lt;<a href="#tecs.system.Result">Result</a>&gt;, force: boolean)
</code></pre>
...
| Type                                                                      | Name                     | Description                                                                                                                |
| ------------------------------------------------------------------------- | ------------------------ | -------------------------------------------------------------------------------------------------------------------------- |
| <code v-pre>Future&lt;<a href="#tecs.system.Result">Result</a>&gt;</code> | <code v-pre>run</code>   | A future `proc.runProcess` handed out. One that has already settled is ignored, so this is safe to call on a race it lost. |
...
<pre><code v-pre>function <a href="#tecs.system.processResult">tecs.system.processResult</a>(run: Future&lt;<a href="#tecs.system.Result">Result</a>&gt;): <a href="#tecs.system.Result">Result</a>
</code></pre>
...
| Type                                                                      | Name                   | Description                                                                              |
| ------------------------------------------------------------------------- | ---------------------- | ---------------------------------------------------------------------------------------- |
| <code v-pre>Future&lt;<a href="#tecs.system.Result">Result</a>&gt;</code> | <code v-pre>run</code> | A future `proc.runProcess` handed out. Any other future answers nil rather than raising. |

#### Returns

| Type                                                        | Description                                                                                                                          |
| ----------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------ |
| <code v-pre><a href="#tecs.system.Result">Result</a></code> | The runner's own record, not a copy, so it fills in as the child runs and the same table is what the future carries when it settles. |
...
<pre><code v-pre>function <a href="#tecs.system.runProcess">tecs.system.runProcess</a>(options: <a href="#tecs.system.Options">Options</a>): Future&lt;<a href="#tecs.system.Result">Result</a>&gt;
</code></pre>

Runs a program and answers a future for it, immediately.

Nothing here blocks. The future reads "pending" until `proc.updateProcesses`, or
...
| Type                                                          | Name                       | Description                                                                                                                                                  |
| ------------------------------------------------------------- | -------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| <code v-pre><a href="#tecs.system.Options">Options</a></code> | <code v-pre>options</code> | Read here and sent to the worker, so a later edit to the same table does not reach the child. Starting the runner is part of this call when nothing has yet. |

#### Returns

| Type                                                                      | Description                                                                                                                                                                                                                                                          |
| ------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <code v-pre>Future&lt;<a href="#tecs.system.Result">Result</a>&gt;</code> | A future that settles "ready" with the result when the child ends, however it ended: a non-zero exit is still "ready", and `succeeded` is what distinguishes them. It settles "failed" only when the child could not be started, and "cancelled" when it was killed. |
