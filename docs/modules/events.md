...
| `timestamp` | `number`  | Nanoseconds since SDL started, as SDL reported it. That epoch is not the clock [`clock.now`](/modules/clock#now) reads, so it orders events against each other and against nothing else.                              |
...
| `mimeTypes`      | `{string}` | Clipboard formats on offer. The same list [`clipboard.mimeTypes`](/modules/clipboard#mimetypes) answers.                                                                                               |
...
Pair it with [`clock.provider`](/modules/clock#driving-a-replay), which replaces the frame delta on the same
terms.
<!-- @generated by docs/scripts/reference.py from src/tecs/platform/events.tl. Do not edit below this line. -->

## Reference

Every function and type this module carries, rendered from `src/tecs/platform/events.tl`.

<a id="tecs.events.Event"></a>

### tecs.events.Event

<pre><code v-pre><a href="#tecs.events.Event">tecs.events.Event</a>: Event
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.events.copy">tecs.events.copy</a>(event: <a href="#tecs.events.Event">Event</a>): <a href="#tecs.events.Event">Event</a>
</code></pre>
...
| --------------------------------------------------------- | ------------------------ | ----------- |
| <code v-pre><a href="#tecs.events.Event">Event</a></code> | <code v-pre>event</code> |             |
...
<a id="tecs.events.drain"></a>

### tecs.events.drain

<pre><code v-pre>function <a href="#tecs.events.drain">tecs.events.drain</a>(queue: loader.CValue, count: integer, handler: function(<a href="#tecs.events.Event">Event</a>), arrivals: loader.CValue)
</code></pre>
...
was produced. Given it, every converted event carries `arrival` in the
units `clock.now` reports.

#### Parameters

| Type                                                                | Name                        | Description |
| ------------------------------------------------------------------- | --------------------------- | ----------- |
| <code v-pre>loader.CValue</code>                                    | <code v-pre>queue</code>    |             |
| <code v-pre>integer</code>                                          | <code v-pre>count</code>    |             |
| <code v-pre>function(<a href="#tecs.events.Event">Event</a>)</code> | <code v-pre>handler</code>  |             |
| <code v-pre>loader.CValue</code>                                    | <code v-pre>arrivals</code> |             |

<a id="tecs.events.isInput"></a>

### tecs.events.isInput

<pre><code v-pre>function <a href="#tecs.events.isInput">tecs.events.isInput</a>(kind: string): boolean
</code></pre>
...
<a id="tecs.events.on"></a>

### tecs.events.on

<pre><code v-pre><a href="#tecs.events.on">tecs.events.on</a>: KindTypes
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.events.push">tecs.events.push</a>(kind: string, fields: <a href="#tecs.events.Event">Event</a>)
</code></pre>
...
### tecs.events.setTouchScale

<pre><code v-pre>function <a href="#tecs.events.setTouchScale">tecs.events.setTouchScale</a>(width: number, height: number)
</code></pre>
...
| Type                      | Name                      | Description |
| ------------------------- | ------------------------- | ----------- |
| <code v-pre>number</code> | <code v-pre>width</code>  |             |
| <code v-pre>number</code> | <code v-pre>height</code> |             |

<a id="tecs.events.source"></a>

### tecs.events.source

<pre><code v-pre>function <a href="#tecs.events.source">tecs.events.source</a>(function(<a href="#tecs.events.Event">Event</a>))
</code></pre>
...
| Type                                                                | Name | Description |
| ------------------------------------------------------------------- | ---- | ----------- |
| <code v-pre>function(<a href="#tecs.events.Event">Event</a>)</code> |      |             |

<a id="tecs.events.typeOf"></a>

### tecs.events.typeOf

<pre><code v-pre>function <a href="#tecs.events.typeOf">tecs.events.typeOf</a>(kind: string): <a href="#tecs.events.Event">Event</a>
</code></pre>
