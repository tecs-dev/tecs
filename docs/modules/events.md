...
The whole surface is `require("tecs")` and every module is a field on it, so this module is `tecs.events`.
...
- [The lifecycle events, and the moment they arrive](https://github.com/tecs-dev/tecs/blob/main/README.md#the-lifecycle-events-and-the-moment-they-arrive)
