...
<!-- @generated by docs/scripts/reference.py from src/tecs/data.tl, src/tecs/compress.tl, src/tecs/hash.tl. Do not edit below this line. -->

## Reference

Every function and type this module carries, rendered from `src/tecs/data.tl`, `src/tecs/compress.tl` and `src/tecs/hash.tl`.

<a id="tecs.data.Sentinel"></a>

### tecs.data.Sentinel

<pre><code v-pre>type <a href="#tecs.data.Sentinel">tecs.data.Sentinel</a> = any
</code></pre>
...
<a id="tecs.data.array_mt"></a>

### tecs.data.array_mt

<pre><code v-pre><a href="#tecs.data.array_mt">tecs.data.array_mt</a>: metatable&lt;{&lt;any type&gt;}&gt;
</code></pre>
...
<a id="tecs.data.decodeJSON"></a>

### tecs.data.decodeJSON

<pre><code v-pre>function <a href="#tecs.data.decodeJSON">tecs.data.decodeJSON</a>(text: string): any
</code></pre>
...
| ------------------------- | ----------------------- | ---------------------------------------------------------------------------------------------- |
| <code v-pre>string</code> | <code v-pre>text</code> | A whole document. Objects and arrays both answer as tables, and a JSON null answers as `null`. |

#### Returns

| Type                   | Description                                                                                                                                                 |
| ---------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <code v-pre>any</code> | The value. Raises on malformed input rather than returning nil, the empty string included, so code that expects to be handed rubbish wraps this in `pcall`. |

<a id="tecs.data.decode_allow_comment"></a>

### tecs.data.decode_allow_comment

<pre><code v-pre>function <a href="#tecs.data.decode_allow_comment">tecs.data.decode_allow_comment</a>(setting: boolean | string): boolean
</code></pre>
...
| Type                                 | Name                       | Description         |
| ------------------------------------ | -------------------------- | ------------------- |
| <code v-pre>boolean \| string</code> | <code v-pre>setting</code> | Omitted only reads. |

#### Returns

| Type                       | Description                 |
| -------------------------- | --------------------------- |
| <code v-pre>boolean</code> | The setting after the call. |

<a id="tecs.data.decode_array_with_array_mt"></a>

### tecs.data.decode_array_with_array_mt

<pre><code v-pre>function <a href="#tecs.data.decode_array_with_array_mt">tecs.data.decode_array_with_array_mt</a>(setting: boolean | string): boolean
</code></pre>
...
<a id="tecs.data.decode_invalid_numbers"></a>

### tecs.data.decode_invalid_numbers

<pre><code v-pre>function <a href="#tecs.data.decode_invalid_numbers">tecs.data.decode_invalid_numbers</a>(setting: boolean | string): boolean
</code></pre>
...
<a id="tecs.data.decode_max_depth"></a>

### tecs.data.decode_max_depth

<pre><code v-pre>function <a href="#tecs.data.decode_max_depth">tecs.data.decode_max_depth</a>(depth: integer): integer
</code></pre>
...
| Type                       | Name                     | Description         |
| -------------------------- | ------------------------ | ------------------- |
| <code v-pre>integer</code> | <code v-pre>depth</code> | Omitted only reads. |

#### Returns

| Type                       | Description               |
| -------------------------- | ------------------------- |
| <code v-pre>integer</code> | The depth after the call. |

<a id="tecs.data.empty_array"></a>

### tecs.data.empty_array

<pre><code v-pre><a href="#tecs.data.empty_array">tecs.data.empty_array</a>: <a href="#tecs.data.Sentinel">Sentinel</a>
</code></pre>
...
<a id="tecs.data.empty_array_mt"></a>

### tecs.data.empty_array_mt

<pre><code v-pre><a href="#tecs.data.empty_array_mt">tecs.data.empty_array_mt</a>: metatable&lt;{&lt;any type&gt;}&gt;
</code></pre>
...
<a id="tecs.data.encodeJSON"></a>

### tecs.data.encodeJSON

<pre><code v-pre>function <a href="#tecs.data.encodeJSON">tecs.data.encodeJSON</a>(value: any): string
</code></pre>
...
| Type                   | Name                     | Description                                                                                                                                      |
| ---------------------- | ------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------ |
| <code v-pre>any</code> | <code v-pre>value</code> | Any Lua value JSON has a form for. Reached recursively, so a table holding itself raises at `encode_max_depth` rather than running out of stack. |

#### Returns

| Type                      | Description                                                  |
| ------------------------- | ------------------------------------------------------------ |
| <code v-pre>string</code> | The document, compact unless `encode_indent` says otherwise. |

<a id="tecs.data.encode_empty_table_as_object"></a>

### tecs.data.encode_empty_table_as_object

<pre><code v-pre>function <a href="#tecs.data.encode_empty_table_as_object">tecs.data.encode_empty_table_as_object</a>(setting: boolean | string): boolean
</code></pre>
...
| Type                                 | Name                       | Description                                                                                                            |
| ------------------------------------ | -------------------------- | ---------------------------------------------------------------------------------------------------------------------- |
| <code v-pre>boolean \| string</code> | <code v-pre>setting</code> | Omitted only reads. A string is read as a boolean, which is how lua-cjson takes a setting out of a configuration file. |
...
<a id="tecs.data.encode_escape_forward_slash"></a>

### tecs.data.encode_escape_forward_slash

<pre><code v-pre>function <a href="#tecs.data.encode_escape_forward_slash">tecs.data.encode_escape_forward_slash</a>(setting: boolean | string): boolean
</code></pre>
...
<a id="tecs.data.encode_indent"></a>

### tecs.data.encode_indent

<pre><code v-pre>function <a href="#tecs.data.encode_indent">tecs.data.encode_indent</a>(indent: string): string
</code></pre>
...
| Type                      | Name                      | Description                                        |
| ------------------------- | ------------------------- | -------------------------------------------------- |
| <code v-pre>string</code> | <code v-pre>indent</code> | Omitted only reads. Whitespace, one level's worth. |

#### Returns

| Type                      | Description                |
| ------------------------- | -------------------------- |
| <code v-pre>string</code> | The indent after the call. |

<a id="tecs.data.encode_invalid_numbers"></a>

### tecs.data.encode_invalid_numbers

<pre><code v-pre>function <a href="#tecs.data.encode_invalid_numbers">tecs.data.encode_invalid_numbers</a>(setting: boolean | string): boolean | string
</code></pre>
...
| Type                                 | Description                                                                                        |
| ------------------------------------ | -------------------------------------------------------------------------------------------------- |
| <code v-pre>boolean \| string</code> | The setting after the call, which is `"null"` rather than a boolean when that is what is in force. |

<a id="tecs.data.encode_keep_buffer"></a>

### tecs.data.encode_keep_buffer

<pre><code v-pre>function <a href="#tecs.data.encode_keep_buffer">tecs.data.encode_keep_buffer</a>(keep: boolean | string): boolean
</code></pre>
...
| Type                                 | Name                    | Description         |
| ------------------------------------ | ----------------------- | ------------------- |
| <code v-pre>boolean \| string</code> | <code v-pre>keep</code> | Omitted only reads. |
...
<a id="tecs.data.encode_max_depth"></a>

### tecs.data.encode_max_depth

<pre><code v-pre>function <a href="#tecs.data.encode_max_depth">tecs.data.encode_max_depth</a>(depth: integer): integer
</code></pre>
...
<a id="tecs.data.encode_number_precision"></a>

### tecs.data.encode_number_precision

<pre><code v-pre>function <a href="#tecs.data.encode_number_precision">tecs.data.encode_number_precision</a>(precision: integer): integer
</code></pre>
...
| Type                       | Name                         | Description                  |
| -------------------------- | ---------------------------- | ---------------------------- |
| <code v-pre>integer</code> | <code v-pre>precision</code> | Omitted only reads. 1 to 14. |

#### Returns

| Type                       | Description                   |
| -------------------------- | ----------------------------- |
| <code v-pre>integer</code> | The precision after the call. |

<a id="tecs.data.encode_skip_unsupported_value_types"></a>

### tecs.data.encode_skip_unsupported_value_types

<pre><code v-pre>function <a href="#tecs.data.encode_skip_unsupported_value_types">tecs.data.encode_skip_unsupported_value_types</a>(setting: boolean | string): boolean
</code></pre>
...
<a id="tecs.data.encode_sparse_array"></a>

### tecs.data.encode_sparse_array

<pre><code v-pre>function <a href="#tecs.data.encode_sparse_array">tecs.data.encode_sparse_array</a>(convert: boolean | string, ratio: integer, safe: integer): boolean, integer, integer
</code></pre>
...
| Type                                 | Name                       | Description                                                                                                       |
| ------------------------------------ | -------------------------- | ----------------------------------------------------------------------------------------------------------------- |
| <code v-pre>boolean \| string</code> | <code v-pre>convert</code> | Omitted only reads, and reads all three.                                                                          |
| <code v-pre>integer</code>           | <code v-pre>ratio</code>   | The multiple of the entry count that the largest index may reach before the array is called sparse. 2 by default. |
| <code v-pre>integer</code>           | <code v-pre>safe</code>    | A largest index below which an array never counts as sparse. 10 by default.                                       |

#### Returns

| Type                       | Description                               |
| -------------------------- | ----------------------------------------- |
| <code v-pre>boolean</code> | Whether conversion is on, off by default. |
| <code v-pre>integer</code> | The ratio after the call.                 |
| <code v-pre>integer</code> | The safe bound after the call.            |

<a id="tecs.data.newJSON"></a>

### tecs.data.newJSON

<pre><code v-pre>function <a href="#tecs.data.newJSON">tecs.data.newJSON</a>(): data
</code></pre>
...
| Type                    | Description                                                                                                                                                                                                              |
| ----------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| <code v-pre>data</code> | A table carrying every name here and none of the compression or hashing `tecs.data` also holds, since those have nothing to configure. The sentinels are shared with every copy, as identity is the whole point of them. |

<a id="tecs.data.null"></a>

### tecs.data.null

<pre><code v-pre><a href="#tecs.data.null">tecs.data.null</a>: <a href="#tecs.data.Sentinel">Sentinel</a>
</code></pre>
...
<a id="tecs.data.deflate"></a>

### tecs.data.deflate

<pre><code v-pre>function <a href="#tecs.data.deflate">tecs.data.deflate</a>(bytes: string, level: integer): string
</code></pre>
...
<a id="tecs.data.deflateRaw"></a>

### tecs.data.deflateRaw

<pre><code v-pre>function <a href="#tecs.data.deflateRaw">tecs.data.deflateRaw</a>(bytes: string, level: integer): string
</code></pre>
...
<a id="tecs.data.inflate"></a>

### tecs.data.inflate

<pre><code v-pre>function <a href="#tecs.data.inflate">tecs.data.inflate</a>(bytes: string, sizeHint: integer): string
</code></pre>
...
<a id="tecs.data.inflateRaw"></a>

### tecs.data.inflateRaw

<pre><code v-pre>function <a href="#tecs.data.inflateRaw">tecs.data.inflateRaw</a>(bytes: string, sizeHint: integer): string
</code></pre>
...
<a id="tecs.data.adler32"></a>

### tecs.data.adler32

<pre><code v-pre>function <a href="#tecs.data.adler32">tecs.data.adler32</a>(text: string): integer
</code></pre>
...
<a id="tecs.data.crc32"></a>

### tecs.data.crc32

<pre><code v-pre>function <a href="#tecs.data.crc32">tecs.data.crc32</a>(text: string): integer
</code></pre>
...
<a id="tecs.data.fnv1a64"></a>

### tecs.data.fnv1a64

<pre><code v-pre>function <a href="#tecs.data.fnv1a64">tecs.data.fnv1a64</a>(text: string): string
</code></pre>
