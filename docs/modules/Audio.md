---
description: "Sound output: clips, voices, groups, keyed limits, fades, pitch, loop points, streaming and the Sound component"
outline: deep
---
...
that should make a noise carries a [`Sound`](#the-sound-component) component rather than a handle a game has to
remember to release.
