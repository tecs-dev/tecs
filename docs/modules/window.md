...
<!-- @generated by `cargo xtask docs-reference` from src/tecs/platform/window.tl. Do not edit below this line. -->

## Reference

Every function and type this module carries, rendered from `src/tecs/platform/window.tl`.

<a id="tecs.window.DisplayMode"></a>

### tecs.window.DisplayMode

<pre><code v-pre>type <a href="#tecs.window.DisplayMode">tecs.window.DisplayMode</a> = <a href="#tecs.window.Window.DisplayMode">Window.DisplayMode</a>
</code></pre>

One fullscreen mode a display offers.

<a id="tecs.window.Flash"></a>

### tecs.window.Flash

<pre><code v-pre>type <a href="#tecs.window.Flash">tecs.window.Flash</a> = <a href="#tecs.window.Window.Flash">Window.Flash</a>
</code></pre>

How hard a window asks for attention.

<a id="tecs.window.Options"></a>

### tecs.window.Options

<pre><code v-pre>type <a href="#tecs.window.Options">tecs.window.Options</a> = <a href="#tecs.window.Window.Options">Window.Options</a>
</code></pre>

What `newWindow` takes.

<a id="tecs.window.Orientation"></a>

### tecs.window.Orientation

<pre><code v-pre>type <a href="#tecs.window.Orientation">tecs.window.Orientation</a> = <a href="#tecs.window.Window.Orientation">Window.Orientation</a>
</code></pre>

Which way up a display is.

<a id="tecs.window.Progress"></a>

### tecs.window.Progress

<pre><code v-pre>type <a href="#tecs.window.Progress">tecs.window.Progress</a> = <a href="#tecs.window.Window.Progress">Window.Progress</a>
</code></pre>

What a taskbar progress indicator shows.

<a id="tecs.window.Theme"></a>

### tecs.window.Theme

<pre><code v-pre>type <a href="#tecs.window.Theme">tecs.window.Theme</a> = <a href="#tecs.window.Window.Theme">Window.Theme</a>
</code></pre>

Light or dark, as the desktop has it.

<a id="tecs.window.Window"></a>

### tecs.window.Window

<pre><code v-pre>record <a href="#tecs.window.Window">tecs.window.Window</a>
</code></pre>

One open window, and the displays around it. Every reader asks SDL
rather than caching, so what a getter answers is what the events were
derived from.
...
<pre><code v-pre>function <a href="#tecs.window.Window.destroy">tecs.window.Window.destroy</a>(self: <a href="#tecs.window.Window">Window</a>)
</code></pre>
...
| ----------------------------------------------------------- | ----------------------- | ----------- |
| <code v-pre><a href="#tecs.window.Window">Window</a></code> | <code v-pre>self</code> |             |

<a id="tecs.window.Window.id"></a>

### tecs.window.Window.id

<pre><code v-pre>function <a href="#tecs.window.Window.id">tecs.window.Window.id</a>(self: <a href="#tecs.window.Window">Window</a>): integer
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.window.Window.sync">tecs.window.Window.sync</a>(self: <a href="#tecs.window.Window">Window</a>): boolean
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.window.Window.getSize">tecs.window.Window.getSize</a>(self: <a href="#tecs.window.Window">Window</a>): integer, integer
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.window.Window.getPixelSize">tecs.window.Window.getPixelSize</a>(self: <a href="#tecs.window.Window">Window</a>): integer, integer
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.window.Window.setSize">tecs.window.Window.setSize</a>(self: <a href="#tecs.window.Window">Window</a>, width: integer, height: integer): boolean
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.window.Window.pixelDensity">tecs.window.Window.pixelDensity</a>(self: <a href="#tecs.window.Window">Window</a>): number
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.window.Window.displayScale">tecs.window.Window.displayScale</a>(self: <a href="#tecs.window.Window">Window</a>): number
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.window.Window.position">tecs.window.Window.position</a>(self: <a href="#tecs.window.Window">Window</a>): integer, integer
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.window.Window.setPosition">tecs.window.Window.setPosition</a>(self: <a href="#tecs.window.Window">Window</a>, x: integer, y: integer): boolean
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.window.Window.center">tecs.window.Window.center</a>(self: <a href="#tecs.window.Window">Window</a>, displayId: integer): boolean
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.window.Window.borderSize">tecs.window.Window.borderSize</a>(self: <a href="#tecs.window.Window">Window</a>): integer, integer, integer, integer
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.window.Window.safeArea">tecs.window.Window.safeArea</a>(self: <a href="#tecs.window.Window">Window</a>): integer, integer, integer, integer
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.window.Window.minimumSize">tecs.window.Window.minimumSize</a>(self: <a href="#tecs.window.Window">Window</a>): integer, integer
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.window.Window.setMinimumSize">tecs.window.Window.setMinimumSize</a>(self: <a href="#tecs.window.Window">Window</a>, width: integer, height: integer): boolean
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.window.Window.maximumSize">tecs.window.Window.maximumSize</a>(self: <a href="#tecs.window.Window">Window</a>): integer, integer
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.window.Window.setMaximumSize">tecs.window.Window.setMaximumSize</a>(self: <a href="#tecs.window.Window">Window</a>, width: integer, height: integer): boolean
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.window.Window.aspectRatio">tecs.window.Window.aspectRatio</a>(self: <a href="#tecs.window.Window">Window</a>): number, number
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.window.Window.setAspectRatio">tecs.window.Window.setAspectRatio</a>(self: <a href="#tecs.window.Window">Window</a>, minimum: number, maximum: number): boolean
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.window.Window.show">tecs.window.Window.show</a>(self: <a href="#tecs.window.Window">Window</a>): boolean
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.window.Window.hide">tecs.window.Window.hide</a>(self: <a href="#tecs.window.Window">Window</a>): boolean
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.window.Window.isVisible">tecs.window.Window.isVisible</a>(self: <a href="#tecs.window.Window">Window</a>): boolean
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.window.Window.raise">tecs.window.Window.raise</a>(self: <a href="#tecs.window.Window">Window</a>): boolean
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.window.Window.isOccluded">tecs.window.Window.isOccluded</a>(self: <a href="#tecs.window.Window">Window</a>): boolean
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.window.Window.hasFocus">tecs.window.Window.hasFocus</a>(self: <a href="#tecs.window.Window">Window</a>): boolean
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.window.Window.hasMouseFocus">tecs.window.Window.hasMouseFocus</a>(self: <a href="#tecs.window.Window">Window</a>): boolean
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.window.Window.setFullscreen">tecs.window.Window.setFullscreen</a>(self: <a href="#tecs.window.Window">Window</a>, fullscreen: boolean): boolean
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.window.Window.isFullscreen">tecs.window.Window.isFullscreen</a>(self: <a href="#tecs.window.Window">Window</a>): boolean
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.window.Window.fullscreenMode">tecs.window.Window.fullscreenMode</a>(self: <a href="#tecs.window.Window">Window</a>): <a href="#tecs.window.Window.DisplayMode">Window.DisplayMode</a>
</code></pre>
...
| Type                                                                                | Description |
| ----------------------------------------------------------------------------------- | ----------- |
| <code v-pre><a href="#tecs.window.Window.DisplayMode">Window.DisplayMode</a></code> |             |

<a id="tecs.window.Window.setFullscreenMode"></a>

### tecs.window.Window.setFullscreenMode

<pre><code v-pre>function <a href="#tecs.window.Window.setFullscreenMode">tecs.window.Window.setFullscreenMode</a>(self: <a href="#tecs.window.Window">Window</a>, mode: <a href="#tecs.window.Window.DisplayMode">Window.DisplayMode</a>): boolean
</code></pre>
...
| ----------------------------------------------------------------------------------- | ----------------------- | ----------- |
| <code v-pre><a href="#tecs.window.Window">Window</a></code>                         | <code v-pre>self</code> |             |
| <code v-pre><a href="#tecs.window.Window.DisplayMode">Window.DisplayMode</a></code> | <code v-pre>mode</code> |             |
...
<pre><code v-pre>function <a href="#tecs.window.Window.setTitle">tecs.window.Window.setTitle</a>(self: <a href="#tecs.window.Window">Window</a>, title: string): boolean
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.window.Window.setIcon">tecs.window.Window.setIcon</a>(self: <a href="#tecs.window.Window">Window</a>, path: string): boolean
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.window.Window.isResizable">tecs.window.Window.isResizable</a>(self: <a href="#tecs.window.Window">Window</a>): boolean
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.window.Window.setResizable">tecs.window.Window.setResizable</a>(self: <a href="#tecs.window.Window">Window</a>, resizable: boolean): boolean
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.window.Window.isBordered">tecs.window.Window.isBordered</a>(self: <a href="#tecs.window.Window">Window</a>): boolean
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.window.Window.setBordered">tecs.window.Window.setBordered</a>(self: <a href="#tecs.window.Window">Window</a>, bordered: boolean): boolean
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.window.Window.isAlwaysOnTop">tecs.window.Window.isAlwaysOnTop</a>(self: <a href="#tecs.window.Window">Window</a>): boolean
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.window.Window.setAlwaysOnTop">tecs.window.Window.setAlwaysOnTop</a>(self: <a href="#tecs.window.Window">Window</a>, onTop: boolean): boolean
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.window.Window.isFocusable">tecs.window.Window.isFocusable</a>(self: <a href="#tecs.window.Window">Window</a>): boolean
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.window.Window.setFocusable">tecs.window.Window.setFocusable</a>(self: <a href="#tecs.window.Window">Window</a>, focusable: boolean): boolean
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.window.Window.opacity">tecs.window.Window.opacity</a>(self: <a href="#tecs.window.Window">Window</a>): number
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.window.Window.setOpacity">tecs.window.Window.setOpacity</a>(self: <a href="#tecs.window.Window">Window</a>, opacity: number): boolean
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.window.Window.flash">tecs.window.Window.flash</a>(self: <a href="#tecs.window.Window">Window</a>, operation: <a href="#tecs.window.Window.Flash">Window.Flash</a>): boolean
</code></pre>
...
| ----------------------------------------------------------------------- | ---------------------------- | ----------- |
| <code v-pre><a href="#tecs.window.Window">Window</a></code>             | <code v-pre>self</code>      |             |
| <code v-pre><a href="#tecs.window.Window.Flash">Window.Flash</a></code> | <code v-pre>operation</code> |             |
...
<pre><code v-pre>function <a href="#tecs.window.Window.progress">tecs.window.Window.progress</a>(self: <a href="#tecs.window.Window">Window</a>): <a href="#tecs.window.Window.Progress">Window.Progress</a>, number
</code></pre>
...
| Type                                                                          | Description |
| ----------------------------------------------------------------------------- | ----------- |
| <code v-pre><a href="#tecs.window.Window.Progress">Window.Progress</a></code> |             |
| <code v-pre>number</code>                                                     |             |
...
<pre><code v-pre>function <a href="#tecs.window.Window.setProgress">tecs.window.Window.setProgress</a>(self: <a href="#tecs.window.Window">Window</a>, state: <a href="#tecs.window.Window.Progress">Window.Progress</a>, value: number): boolean
</code></pre>
...
| ----------------------------------------------------------------------------- | ------------------------ | ----------- |
| <code v-pre><a href="#tecs.window.Window">Window</a></code>                   | <code v-pre>self</code>  |             |
| <code v-pre><a href="#tecs.window.Window.Progress">Window.Progress</a></code> | <code v-pre>state</code> |             |
...
<pre><code v-pre>function <a href="#tecs.window.Window.mouseGrab">tecs.window.Window.mouseGrab</a>(self: <a href="#tecs.window.Window">Window</a>): boolean
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.window.Window.setMouseGrab">tecs.window.Window.setMouseGrab</a>(self: <a href="#tecs.window.Window">Window</a>, grabbed: boolean): boolean
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.window.Window.keyboardGrab">tecs.window.Window.keyboardGrab</a>(self: <a href="#tecs.window.Window">Window</a>): boolean
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.window.Window.setKeyboardGrab">tecs.window.Window.setKeyboardGrab</a>(self: <a href="#tecs.window.Window">Window</a>, grabbed: boolean): boolean
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.window.Window.mouseRect">tecs.window.Window.mouseRect</a>(self: <a href="#tecs.window.Window">Window</a>): integer, integer, integer, integer
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.window.Window.setMouseRect">tecs.window.Window.setMouseRect</a>(self: <a href="#tecs.window.Window">Window</a>, x: integer, y: integer, width: integer, height: integer): boolean
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.window.Window.display">tecs.window.Window.display</a>(self: <a href="#tecs.window.Window">Window</a>): integer
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.window.Window.orientation">tecs.window.Window.orientation</a>(displayId: integer): <a href="#tecs.window.Window.Orientation">Window.Orientation</a>
</code></pre>
...
| Type                                                                                | Description |
| ----------------------------------------------------------------------------------- | ----------- |
| <code v-pre><a href="#tecs.window.Window.Orientation">Window.Orientation</a></code> |             |

<a id="tecs.window.Window.naturalOrientation"></a>

### tecs.window.Window.naturalOrientation

<pre><code v-pre>function <a href="#tecs.window.Window.naturalOrientation">tecs.window.Window.naturalOrientation</a>(displayId: integer): <a href="#tecs.window.Window.Orientation">Window.Orientation</a>
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.window.Window.desktopMode">tecs.window.Window.desktopMode</a>(displayId: integer): <a href="#tecs.window.Window.DisplayMode">Window.DisplayMode</a>
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.window.Window.currentMode">tecs.window.Window.currentMode</a>(displayId: integer): <a href="#tecs.window.Window.DisplayMode">Window.DisplayMode</a>
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.window.Window.fullscreenModes">tecs.window.Window.fullscreenModes</a>(displayId: integer): {<a href="#tecs.window.Window.DisplayMode">Window.DisplayMode</a>}
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.window.Window.closestFullscreenMode">tecs.window.Window.closestFullscreenMode</a>(width: integer, height: integer, refreshRate: number, highDensity: boolean, displayId: integer): <a href="#tecs.window.Window.DisplayMode">Window.DisplayMode</a>
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.window.Window.theme">tecs.window.Window.theme</a>(): <a href="#tecs.window.Window.Theme">Window.Theme</a>
</code></pre>
...
| Type                                                                    | Description |
| ----------------------------------------------------------------------- | ----------- |
| <code v-pre><a href="#tecs.window.Window.Theme">Window.Theme</a></code> |             |
...
<a id="tecs.window.newWindow"></a>

### tecs.window.newWindow

<pre><code v-pre>function <a href="#tecs.window.newWindow">tecs.window.newWindow</a>(options: <a href="#tecs.window.Window.Options">Window.Options</a>): <a href="#tecs.window.Window">Window</a>
</code></pre>
...
| Type                                                                        | Name                       | Description |
| --------------------------------------------------------------------------- | -------------------------- | ----------- |
| <code v-pre><a href="#tecs.window.Window.Options">Window.Options</a></code> | <code v-pre>options</code> |             |

#### Returns

| Type                                                        | Description |
| ----------------------------------------------------------- | ----------- |
| <code v-pre><a href="#tecs.window.Window">Window</a></code> |             |
