...
<!-- @generated by `cargo xtask docs-reference` from src/tecs/platform/input.tl, src/tecs/platform/Gamepad.tl, src/tecs/platform/sensors.tl. Do not edit below this line. -->
...
<pre><code v-pre><a href="#tecs.input.Gamepad">tecs.input.Gamepad</a>: Gamepad
</code></pre>

One attached gamepad, which answers for itself: it has identity, a
lifetime, metadata and outputs, so it is a class rather than a reading
off the state above.
...
<pre><code v-pre>record <a href="#tecs.input.Input">tecs.input.Input</a>
</code></pre>

Gameplay input, folded once a frame and read in three tiers: live
state, frame events and the latched sets a fixed step reads.

<a id="tecs.input.Input.Layer"></a>

### tecs.input.Input.Layer

<pre><code v-pre><a href="#tecs.input.Input.Layer">tecs.input.Input.Layer</a>: <a href="#tecs.input.Layer">Layer</a>
</code></pre>
...
<pre><code v-pre><a href="#tecs.input.Input.Touch">tecs.input.Input.Touch</a>: <a href="#tecs.input.Touch">Touch</a>
</code></pre>
...
<pre><code v-pre><a href="#tecs.input.Input.TextArea">tecs.input.Input.TextArea</a>: <a href="#tecs.input.TextArea">TextArea</a>
</code></pre>
...
<pre><code v-pre><a href="#tecs.input.Input.TextOptions">tecs.input.Input.TextOptions</a>: <a href="#tecs.input.TextOptions">TextOptions</a>
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.input.Input.stopTextInput">tecs.input.Input.stopTextInput</a>(self: <a href="#tecs.input.Input">Input</a>): boolean
</code></pre>
...
| -------------------------------------------------------- | ----------------------- | ----------- |
| <code v-pre><a href="#tecs.input.Input">Input</a></code> | <code v-pre>self</code> |             |
...
<pre><code v-pre>function <a href="#tecs.input.Input.setTextInputArea">tecs.input.Input.setTextInputArea</a>(self: <a href="#tecs.input.Input">Input</a>, area: <a href="#tecs.input.Input.TextArea">TextArea</a>): boolean
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.input.Input.pushLayer">tecs.input.Input.pushLayer</a>(self: <a href="#tecs.input.Input">Input</a>, name: string, blocking: boolean): <a href="#tecs.input.Input.Layer">Layer</a>
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.input.Input.popLayer">tecs.input.Input.popLayer</a>(self: <a href="#tecs.input.Input">Input</a>): <a href="#tecs.input.Input.Layer">Layer</a>
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.input.Input.topLayer">tecs.input.Input.topLayer</a>(self: <a href="#tecs.input.Input">Input</a>): <a href="#tecs.input.Input.Layer">Layer</a>
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.input.Input.canRead">tecs.input.Input.canRead</a>(self: <a href="#tecs.input.Input">Input</a>, layer: <a href="#tecs.input.Input.Layer">Layer</a>): boolean
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.input.Input.beginFrame">tecs.input.Input.beginFrame</a>(self: <a href="#tecs.input.Input">Input</a>)
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.input.Input.enterFixedPhase">tecs.input.Input.enterFixedPhase</a>(self: <a href="#tecs.input.Input">Input</a>)
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.input.Input.exitFixedPhase">tecs.input.Input.exitFixedPhase</a>(self: <a href="#tecs.input.Input">Input</a>)
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.input.Input.refreshDevices">tecs.input.Input.refreshDevices</a>(self: <a href="#tecs.input.Input">Input</a>)
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.input.Input.gamepads">tecs.input.Input.gamepads</a>(self: <a href="#tecs.input.Input">Input</a>): {<a href="#tecs.input.Gamepad">Gamepad</a>}
</code></pre>
...
| Type                                                           | Description |
| -------------------------------------------------------------- | ----------- |
| <code v-pre>{<a href="#tecs.input.Gamepad">Gamepad</a>}</code> |             |

<a id="tecs.input.Input.gamepad"></a>

### tecs.input.Input.gamepad

<pre><code v-pre>function <a href="#tecs.input.Input.gamepad">tecs.input.Input.gamepad</a>(self: <a href="#tecs.input.Input">Input</a>, index: integer): <a href="#tecs.input.Gamepad">Gamepad</a>
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.input.Input.gamepadById">tecs.input.Input.gamepadById</a>(self: <a href="#tecs.input.Input">Input</a>, id: number): <a href="#tecs.input.Gamepad">Gamepad</a>
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.input.Input.destroy">tecs.input.Input.destroy</a>(self: <a href="#tecs.input.Input">Input</a>)
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.input.Input.handleEvent">tecs.input.Input.handleEvent</a>(self: <a href="#tecs.input.Input">Input</a>, event: eventStream.Event)
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.input.Input.scancode">tecs.input.Input.scancode</a>(self: <a href="#tecs.input.Input">Input</a>, name: string): integer
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.input.Input.keyName">tecs.input.Input.keyName</a>(self: <a href="#tecs.input.Input">Input</a>, scancode: integer): string
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.input.Input.keyDown">tecs.input.Input.keyDown</a>(self: <a href="#tecs.input.Input">Input</a>, key: string | integer, layer: <a href="#tecs.input.Input.Layer">Layer</a>): boolean
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.input.Input.keyPressed">tecs.input.Input.keyPressed</a>(self: <a href="#tecs.input.Input">Input</a>, key: string | integer, layer: <a href="#tecs.input.Input.Layer">Layer</a>): boolean
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.input.Input.keyReleased">tecs.input.Input.keyReleased</a>(self: <a href="#tecs.input.Input">Input</a>, key: string | integer, layer: <a href="#tecs.input.Input.Layer">Layer</a>): boolean
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.input.Input.modifiers">tecs.input.Input.modifiers</a>(self: <a href="#tecs.input.Input">Input</a>): integer
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.input.Input.modifierDown">tecs.input.Input.modifierDown</a>(self: <a href="#tecs.input.Input">Input</a>, name: string, layer: <a href="#tecs.input.Input.Layer">Layer</a>): boolean
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.input.Input.mouseDown">tecs.input.Input.mouseDown</a>(self: <a href="#tecs.input.Input">Input</a>, button: string | integer, layer: <a href="#tecs.input.Input.Layer">Layer</a>): boolean
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.input.Input.mousePressed">tecs.input.Input.mousePressed</a>(self: <a href="#tecs.input.Input">Input</a>, button: string | integer, layer: <a href="#tecs.input.Input.Layer">Layer</a>): boolean
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.input.Input.mouseReleased">tecs.input.Input.mouseReleased</a>(self: <a href="#tecs.input.Input">Input</a>, button: string | integer, layer: <a href="#tecs.input.Input.Layer">Layer</a>): boolean
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.input.Input.setRelativeMouseMode">tecs.input.Input.setRelativeMouseMode</a>(self: <a href="#tecs.input.Input">Input</a>, enabled: boolean): boolean
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.input.Input.relativeMouseMode">tecs.input.Input.relativeMouseMode</a>(self: <a href="#tecs.input.Input">Input</a>): boolean
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.input.Input.warpMouse">tecs.input.Input.warpMouse</a>(self: <a href="#tecs.input.Input">Input</a>, x: number, y: number)
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.input.Input.captureMouse">tecs.input.Input.captureMouse</a>(self: <a href="#tecs.input.Input">Input</a>, enabled: boolean): boolean
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.input.Input.showCursor">tecs.input.Input.showCursor</a>(self: <a href="#tecs.input.Input">Input</a>, visible: boolean): boolean
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.input.Input.cursorVisible">tecs.input.Input.cursorVisible</a>(self: <a href="#tecs.input.Input">Input</a>): boolean
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.input.Input.setCursor">tecs.input.Input.setCursor</a>(self: <a href="#tecs.input.Input">Input</a>, name: string): boolean
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.input.Input.touches">tecs.input.Input.touches</a>(self: <a href="#tecs.input.Input">Input</a>, layer: <a href="#tecs.input.Input.Layer">Layer</a>): {<a href="#tecs.input.Input.Touch">Touch</a>}
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.input.Input.startTextInput">tecs.input.Input.startTextInput</a>(self: <a href="#tecs.input.Input">Input</a>, layer: <a href="#tecs.input.Input.Layer">Layer</a>, options: <a href="#tecs.input.Input.TextOptions">TextOptions</a>): boolean
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.input.Input.textInputActive">tecs.input.Input.textInputActive</a>(self: <a href="#tecs.input.Input">Input</a>): boolean
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.input.Input.textInputLayer">tecs.input.Input.textInputLayer</a>(self: <a href="#tecs.input.Input">Input</a>): <a href="#tecs.input.Input.Layer">Layer</a>
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.input.Input.screenKeyboardSupported">tecs.input.Input.screenKeyboardSupported</a>(self: <a href="#tecs.input.Input">Input</a>): boolean
</code></pre>
...
<pre><code v-pre>type <a href="#tecs.input.Layer">tecs.input.Layer</a> = Layer
</code></pre>
...
<pre><code v-pre>type <a href="#tecs.input.Options">tecs.input.Options</a> = InputOptions
</code></pre>
...
### tecs.input.SensorDevice

<pre><code v-pre>type <a href="#tecs.input.SensorDevice">tecs.input.SensorDevice</a> = <a href="#tecs.input.sensors">sensors</a>.Device
</code></pre>
...
<pre><code v-pre>type <a href="#tecs.input.TextArea">tecs.input.TextArea</a> = TextArea
</code></pre>
...
### tecs.input.TextOptions

<pre><code v-pre>type <a href="#tecs.input.TextOptions">tecs.input.TextOptions</a> = TextOptions
</code></pre>
...
<pre><code v-pre>type <a href="#tecs.input.Touch">tecs.input.Touch</a> = Touch
</code></pre>
...
### tecs.input.TouchpadFinger

<pre><code v-pre>type <a href="#tecs.input.TouchpadFinger">tecs.input.TouchpadFinger</a> = <a href="#tecs.input.Gamepad">Gamepad</a>.TouchpadFinger
</code></pre>
...
<pre><code v-pre>function <a href="#tecs.input.newInput">tecs.input.newInput</a>(options: InputOptions): <a href="#tecs.input.Input">Input</a>
</code></pre>
...
| Type                            | Name                       | Description                                                                                                                                                               |
| ------------------------------- | -------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| <code v-pre>InputOptions</code> | <code v-pre>options</code> | Omitted opens against no window, which is what a headless tool or a spec wants: keys and pads still fold, and anything asking about a window answers as if there is none. |

#### Returns

| Type                                                     | Description                                                                                     |
| -------------------------------------------------------- | ----------------------------------------------------------------------------------------------- |
| <code v-pre><a href="#tecs.input.Input">Input</a></code> | The state. One per application; the application builds its own and a second is only for a test. |
