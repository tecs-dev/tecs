...
<pre><code v-pre>function <a href="#tecs.animation.of">tecs.animation.of</a>(source: Sheet, tag: string, options: <a href="#tecs.animation.PlayOptions">PlayOptions</a>): <a href="#tecs.animation.Animation">Animation</a>
</code></pre>
...
| Type                                                                     | Name                       | Description                                                |
| ------------------------------------------------------------------------ | -------------------------- | ---------------------------------------------------------- |
| <code v-pre>Sheet</code>                                                 | <code v-pre>source</code>  | The sheet to play. Nil raises.                             |
...
<pre><code v-pre>function <a href="#tecs.animation.play">tecs.animation.play</a>(world: World, entity: integer, source: Sheet, tag: string, options: <a href="#tecs.animation.PlayOptions">PlayOptions</a>)
</code></pre>
