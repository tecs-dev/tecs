...
describe("the file watcher", function()
    ...
    it("watches what was loaded rather than what is in the tree", function()
        ...
        assert.is_string(assets.read(dir .. "opened.glsl"))
