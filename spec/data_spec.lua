...
describe("tecs.data", function()
    ...
    it("publishes key registry operations on Store", function()
        assert.are.equal("function", type(data.Store.newKey))
        assert.are.equal("function", type(data.Store.findKey))
        assert.are.equal("function", type(data.Store.listKeys))
