...
describe("the public surface", function()
    ...
    it("does not retain the platform modules at the root", function()
        assert.is_nil(tecs.events)
        assert.is_nil(tecs.input)
    ...
    describe("the platform namespace", function()
        it("hangs platform facilities below their parent without flat aliases", function()
            assert.is_true(rawequal(tecs.platform.events, require("tecs.platform.events")))
            assert.is_true(rawequal(tecs.platform.input, require("tecs.platform.input")))
