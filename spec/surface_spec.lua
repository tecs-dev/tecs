...
describe("the public surface", function()
    ...
    describe("the platform namespace", function()
        it("hangs platform facilities below their parent", function()
            ...
            assert.is_function(tecs.platform.os.newSignalListener)
    ...
    describe("a module inside a module", function()
        ...
        it("hangs child modules below the parent, once", function()
            ...
            assert.is_nil(tecs.io.path)
            assert.is_nil(tecs.io.process)
            assert.is_nil(tecs.io.uri)
            assert.is_nil(tecs.io.newPath)
            assert.is_nil(tecs.io.newURI)
            assert.is_nil(tecs.io.newStreamWithMetadata)
            assert.is_nil(tecs.io.File)
            assert.is_nil(tecs.io.ProcessReader)
            assert.is_nil(tecs.io.ProcessWriter)
        ...
        it("exposes preference configuration on the principal module", function()
            ...
            assert.is_function(tecs.io.files.open)
            assert.is_nil(tecs.io.files.append)
            assert.is_nil(tecs.io.files.openRead)
            assert.is_nil(tecs.io.files.openWrite)
            assert.is_nil(tecs.io.files.openSeekableWrite)
