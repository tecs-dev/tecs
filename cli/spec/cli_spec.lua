...
describe("tecs CLI", function()
    ...
    describe("commands", function()
        it("creates a new fixed-layout project from checked-in template source", function()
            ...
            assert.matches('"tl == dev%-1"', rockspec)
            assert.matches('"tecs == dev%-1"', rockspec)
            assert.matches('"tecs2d == dev%-1"', rockspec)
            assert.matches('"luajit%-tl%-type == 0%.0%.2"', rockspec)
            assert.matches('"luasocket%-tl%-type == 0%.0%.2"', rockspec)
            assert.matches('"tecs%-love2d%-tl%-type >= 0%.1%.0"', rockspec)
