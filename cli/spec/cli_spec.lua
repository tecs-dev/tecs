...
describe("tecs CLI", function()
    ...
    describe("commands", function()
        it("creates a new fixed-layout project from checked-in template source", function()
            ...
            assert.is_nil(rockspec:match('"tl == dev%-1"'))
            assert.is_nil(rockspec:match('"tecs == dev%-1"'))
            assert.is_nil(rockspec:match('"luajit%-tl%-type'))
            assert.is_nil(rockspec:match('"luasocket%-tl%-type'))
            assert.is_nil(rockspec:match('"tecs%-love2d%-tl%-type'))
            ...
            assert.is_nil(main:match('love%.graphics'))
            assert.is_nil(main:match('DrawHello'))
