...
cp "$root/tecs_cli/version.lua" "$stage/tecs_cli/version.lua"
cp "$root/tecs_cli/cliApi.lua" "$stage/tecs_cli/cliApi.lua"
cp "$root/tecs_cli/cliDocs.lua" "$stage/tecs_cli/cliDocs.lua"
cp "$root/tecs_cli/diagnostics.lua" "$stage/tecs_cli/diagnostics.lua"
cp "$root/tecs_cli/cliFileSystem.lua" "$stage/tecs_cli/cliFileSystem.lua"
cp "$root/tecs_cli/cliParser.lua" "$stage/tecs_cli/cliParser.lua"
...
cp "$tecs_dir/CHANGELOG.md" "$root/dist/CHANGELOG.md"
